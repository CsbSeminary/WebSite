...
<asp:Content runat="server" ContentPlaceHolderID="cb">
    ...
    <div style="margin: 22px 0 0 34px; width:425px; float: left;">
        <div style="width:425px; height: 170px; float:left;">
            <div id="virtual-tour">
                <img alt="" src="/cms/Media/Images/header_get_involved.png" /><div class="separator-black" style="margin-top:3px;"></div>
                <div class="content">
                    <a href="http://csbs.ca/pages/csbs/splash/history-celebration-project.html"><img alt="" src="http://www.csbs.ca/cms/Media/Images/get_involved_history_project.jpg" /></a>
                </div>
            </div>

            <div id="take-note">
                <img alt="" src="/cms/Media/Images/header_online_news.png" /><div class="separator-black" style="margin-top:3px;"></div>
                <div class="content">
        ...
        <div id="partners">
            <div class="images">
                <a href="/pages/csbs/about/accreditation.html"><img alt="" src="/cms/Media/Images/logo_abhe.png" /></a>
                <a href="/pages/csbs/about/accreditation.html"><img alt="" src="/cms/Media/Images/logo_ats.png" style="margin-left:13px;" /></a>
                <a href="/pages/csbs/about/accreditation.html"><img alt="" src="/cms/Media/Images/logo_governament_ab.png" style="margin-left:13px;" /></a>
            </div>
            <div class="text">
    ...
    <div id="news">
        <div class="note"> <a href="/pages/csbs/current/seminarynews.html" target="_self"><img alt="" src="/cms/Media/Images/header_seminary_news.png" style="margin-left: 4px;" /></a>
          <div class="separator-black" style="margin-top:1px;"></div>
            ...
            <a href="/pages/csbs/current/seminarynews.html" target="_self"><img alt="" src="/cms/Media/Images/image_seminary_news.png" style="position: relative; top: -113px; right: -104px;" /></a>
        </div>
        <div class="note cnb-links"> <a href="http://www.cnbc.ca" target="new"><img alt="" src="/cms/Media/Images/header_cnbc_links.png" style="margin: -3px 0 0 4px;" /></a>
